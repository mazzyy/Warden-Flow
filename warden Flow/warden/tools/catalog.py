...
CATALOG: dict[str, ToolSpec] = {
    ...
    for spec in [
        ...
        ToolSpec(
            ...
            scopes=frozenset({READ_SOURCE}),
            description="List files in the local source directory being delivered.",
        ),
        ToolSpec(
            name="read_source_file",
            scopes=frozenset({READ_SOURCE}),
            description="Read a file from the local source directory being delivered.",
        ),
        ToolSpec(
            name="propose_patch",
